...
import { LANDSCAPE_KEYS } from './landscapeKeyShapes'
import './LandscapeKeyboard.css'
...
export function LandscapeKeyboard() {
  ...
  const whiteKeys = LANDSCAPE_KEYS.filter(k => !k.isBlack)
  const blackKeys = LANDSCAPE_KEYS.filter(k => k.isBlack)

  return (
    <div className="landscape-keyboard">
      <svg
        ref={svgRef}
        viewBox="0 0 200 75"
